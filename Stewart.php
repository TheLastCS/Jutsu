                        ...
                        <div class="card  neumorphic4 inset3" style="border: none;">
                          <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                              <img src="image/Preset1.jpg" alt="Admin" class="rounded-circle" width="150">
                              <div class="mt-3">
                                <h4>Christian Stewart</h4>
                                <p class="text-secondary mb-1">Computer Science Student</p>
                                <p class="text-muted font-size-sm">Cebu City, Cebu, PH</p>
                        ...
                        <div class="card mt-3" style="border: none;">
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap neumorphic4 inset3">
                              ...
                              <a href="https://www.youtube.com/channel/UCQ1Wu4srK7VvsEzrwzAiskg" style="text-decoration: none;"><span class="text-secondary">TheLast</span></a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap neumorphic4 inset3">
                              <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github mr-2 icon-inline"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>Github</h6>
                              <a href="https://github.com/TheLast22" style="text-decoration: none;"><span class="text-secondary">github.com/TheLast22</span></a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap neumorphic4 inset3">
                              <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter mr-2 icon-inline text-info"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>Twitter</h6>
                              <a href="https://twitter.com/Stewart_ca8" style="text-decoration: none;"><span class="text-secondary">@Stewart_ca8</span></a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap neumorphic4 inset3">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap neumorphic4 inset3">
                              ...
                              <a href="https://www.facebook.com/stewart.ca.8" style="text-decoration: none;"><span class="text-secondary">/stewart.ca.8</span></a>
                            </li>
                          </ul>
                        </div>
                      </div>
                          ...
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-secondary">
                                Christian Anthony Concepcion Stewart
                              </div>
                            </div>
                            <hr>
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-secondary">
                                christianstewart2202@gmail.com
                              </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-secondary">
                                Golden Valley Homes Subdivision, Lahug, Cebu City, Cebu, Philippines
                              </div>
                            </div>
                            <br>
                          </div>
                          ...
                          <div class="col-sm-6 mb-3">
                            <div class="card h-100 neumorphic4 inset5">
                              <div class="card-body">
                                ...
                                <small>Wireframing and Mockups</small>
                                <div class="progress mb-3" style="height: 5px">
                          ...
                          <div class="col-sm-6 mb-3">
                            <div class="card h-100 neumorphic4 inset5">
                              <div class="card-body">
                                ...
                                <small>Premiere Pro / Videography</small>
                                <div class="progress mb-3" style="height: 5px">
