    ...
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
       <!-- navbar -->
        ...
        <main class="page-content pt-2 neumorphic3">
            ...
            <div class="tryme"><h1>Homepage</h1></div>
        ...
        <div class="feature">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 feature-col inset4">
                        <div class="feature-content">
                            <i class="fab fa-cc-mastercard"></i>
                            <h2>Secure Payment</h2>
                            <p>
                                Your money finds its way
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-col inset4">
                    ...
                    <div class="col-lg-3 col-md-6 feature-col inset4">
                        <div class="feature-content">
                            ...
                            <p>
                                Your dissatisfaction changes our ways
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-col inset4">
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                        ...
                        <div class="product-item neumorphic4">
                            ...
                            <div class="product-image">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="artist_1-2"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="product-item neumorphic4">
                            ...
                            <div class="product-image">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="artist_3-2"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <div class="product-price">
                                <h3><span>$</span>67</h3>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item neumorphic4">
                            <div class="product-title">
                                <a href="artist_5-1.php">Sunflower</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    ...
                    <div class="col-lg-3">
                        <div class="product-item neumorphic4">
                            <div class="product-title">
                                <a href="artist_5-3">Comic Graphic</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="product-image">
                                ...
                                <div class="product-action">
                                    <a href="cart.php"><i class="fa fa-cart-plus"></i></a>
                                    <a href="artist_5.php"><i class="fa fa-user"></i></a>
                                    <a href="artist_5-3"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <div class="product-price">
                                <h3><span>$</span>88</h3>
                        ...
                        <div class="product-item neumorphic4">
                            ...
                            <div class="product-image">
                                ...
                                <div class="product-action">
                                    <a href="cart.php"><i class="fa fa-cart-plus"></i></a>
                                    <a href="artist_2.php"><i class="fa fa-user"></i></a>
                                    <a href="artist_2-1"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <div class="product-price">
                                <h3><span>$</span>45</h3>
